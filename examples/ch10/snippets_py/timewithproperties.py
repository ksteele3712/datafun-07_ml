...
if __name__ == "__main__":
    time = Time(10, 30, 45)
    print(time)  # prints time in 12-hour format
    print(repr(time))  # prints detailed time information

    time.hour = 14
    time.minute = 15
    time.second = 30
    print(time)  # prints updated time in 12-hour format

    time.time = (23, 59, 59)  # set time using tuple
    print(time)  # prints updated time in 12-hour format
    print("Hour:", time.hour)
    print("Minute:", time.minute)
    print("Second:", time.second)
    print("Time tuple:", time.time)
